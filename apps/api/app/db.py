...
LOCAL_DATABASE_URL = "postgresql://pakodi_reader:local-reader-only@127.0.0.1:5433/pakodi"
LOCAL_MIGRATION_URL = "postgresql://pakodi_owner:local-owner-only@127.0.0.1:5433/pakodi"
